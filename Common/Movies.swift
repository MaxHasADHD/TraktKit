...
extension TraktManager {
     ...
     */
    @discardableResult
    public func getTrendingMovies(page: Int, limit: Int, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getPopularMovies(page: Int, limit: Int, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getPlayedMovies(page: Int, limit: Int, period: Period = .Weekly, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getWatchedMovies(page: Int, limit: Int, period: Period = .Weekly, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getCollectedMovies(page: Int, limit: Int, period: Period = .Weekly, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getAnticipatedMovies(page: Int, limit: Int, period: Period = .Weekly, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getWeekendBoxOffice(completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getMovieSummary(movieID id: NSNumber, extended: extendedType = .Min, completion: @escaping ResultCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getMovieTranslations<T: CustomStringConvertible>(movieID id: T, language: String?, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getRelatedMovies<T: CustomStringConvertible>(movieID id: T, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
    @discardableResult
    public func getMovieStatistics<T: CustomStringConvertible>(movieID id: T, completion: @escaping ResultCompletionHandler) -> URLSessionDataTask? {
