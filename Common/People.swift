...
extension TraktManager {
     ...
     */
    @discardableResult
    public func getMovieCredits<T: CustomStringConvertible>(personID id: T, extended: extendedType = .Min, completion: @escaping ResultCompletionHandler) -> URLSessionDataTask? {
     ...
     */
    @discardableResult
    public func getShowCredits<T: CustomStringConvertible>(personID id: T, extended: extendedType = .Min, completion: @escaping ResultCompletionHandler) -> URLSessionDataTask? {
        return getCredits(type: WatchedType.Shows, id: id, extended: extended, completion: completion)
    }
    
    // MARK: - Private
    @discardableResult
    private func getCredits<T: CustomStringConvertible>(type: WatchedType, id: T, extended: extendedType = .Min, completion: @escaping ResultCompletionHandler) -> URLSessionDataTask? {
        // Request
