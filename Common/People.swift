...
extension TraktManager {
     ...
     */
    public func getMovieCredits<T: CustomStringConvertible>(personID id: T, completion: dictionaryCompletionHandler) -> NSURLSessionDataTask? {
     ...
     */
    public func getShowCredits<T: CustomStringConvertible>(personID id: T, completion: dictionaryCompletionHandler) -> NSURLSessionDataTask? {
