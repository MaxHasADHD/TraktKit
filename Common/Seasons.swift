...
extension TraktManager {
     ...
     */
    @discardableResult
    public func getSeasons<T: CustomStringConvertible>(showID id: T, extended: extendedType = .Min, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
     ...
     */
    @discardableResult
    public func getEpisodesForSeason<T: CustomStringConvertible>(showID id: T, season: NSNumber, extended: extendedType = .Min, completion: @escaping ArrayCompletionHandler) -> URLSessionDataTask? {
    ...
    */
     ...
     */
    @discardableResult
    public func getSeasonStatistics<T: CustomStringConvertible>(showID id: T, season: NSNumber, completion: @escaping ResultCompletionHandler) -> URLSessionDataTask? {
