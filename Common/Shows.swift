...
extension TraktManager {
     ...
     */
    @discardableResult
    public func getAnticipatedShows(page: Int, limit: Int, period: Period = .Weekly, extended: [ExtendedType] = [.Min], completion: AnticipatedShowCompletionHandler) -> URLSessionDataTask? {
