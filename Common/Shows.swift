...
extension TraktManager {
    ...
    public func trendingShows(page page: Int, limit: Int, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/trending?page=\(page)&limit=\(limit)&extended=full,images", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
    ...
    /**
     ...
     📄 Pagination
    */
    public func popularShows(page page: Int, limit: Int, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/popular?page=\(page)&limit=\(limit)&extended=full,images", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
        request.cachePolicy = NSURLRequestCachePolicy.ReloadIgnoringLocalCacheData
    ...
    public func getPlayedShows(page page: Int, limit: Int, period: Period = .Weekly, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/played/\(period.rawValue)?page=\(page)&limit=\(limit)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
        request.cachePolicy = NSURLRequestCachePolicy.ReloadIgnoringLocalCacheData
    ...
    public func getWatchedShows(page page: Int, limit: Int, period: Period = .Weekly, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/watched/\(period.rawValue)?page=\(page)&limit=\(limit)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
        request.cachePolicy = NSURLRequestCachePolicy.ReloadIgnoringLocalCacheData
    ...
    public func getCollectedShows(page page: Int, limit: Int, period: Period = .Weekly, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/collected/\(period.rawValue)?page=\(page)&limit=\(limit)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
        request.cachePolicy = NSURLRequestCachePolicy.ReloadIgnoringLocalCacheData
    ...
    public func getAnticipatedShows(page page: Int, limit: Int, period: Period = .Weekly, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/anticipated/\(period.rawValue)?page=\(page)&limit=\(limit)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
        request.cachePolicy = NSURLRequestCachePolicy.ReloadIgnoringLocalCacheData
    ...
    public func getUpdatedShows(page page: Int, limit: Int, startDate: String, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/updates/\(startDate)?page=\(page)&limit=\(limit)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
        request.cachePolicy = NSURLRequestCachePolicy.ReloadIgnoringLocalCacheData
    ...
    */
    public func getShowSummary(traktID: NSNumber, extended: extendedType = .Min, completion: dictionaryCompletionHandler) -> NSURLSessionDataTask? {

        guard let request = mutableRequestForURL("shows/\(traktID)?extended=\(extended.rawValue)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
     ...
     */
    public func getAliases(id: String, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(id)", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
    ...
    /**
     */
    public func getTranslations(completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
    ...
    /**
     ...
     📄 Pagination
     */
    public func getShowComments(slug: String, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(slug)/comments", authorization: false, HTTPMethod: "GET") else {
            return nil
        }
     ...
     */
    public func getShowPeople(traktID: NSNumber, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(traktID)/people", authorization: false, HTTPMethod: "GET") else { return nil }
     ...
     */
    public func getShowRatings(traktID: NSNumber, completion: dictionaryCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(traktID)/ratings", authorization: false, HTTPMethod: "GET") else { return nil }
     ...
     */
    public func getRelatedShows(traktID: NSNumber, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(traktID)/related", authorization: false, HTTPMethod: "GET") else { return nil }
     ...
     */
    public func getShowStatistics(traktID: NSNumber, completion: dictionaryCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(traktID)/stats", authorization: false, HTTPMethod: "GET") else { return nil }
     ...
     */
    public func getWatching(traktID: NSNumber, completion: arrayCompletionHandler) -> NSURLSessionDataTask? {
        guard let request = mutableRequestForURL("shows/\(traktID)/watching", authorization: false, HTTPMethod: "GET") else { return nil }
