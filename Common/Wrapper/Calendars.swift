...
extension TraktManager {
     ...
     */
    @discardableResult
    public func allMovies(startDateString dateString: String, days: Int, completion: @escaping ObjectsCompletionHandler<CalendarMovie>) -> URLSessionDataTaskProtocol? {
