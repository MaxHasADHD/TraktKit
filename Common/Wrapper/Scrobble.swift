...
extension TraktManager {
     ...
     */
    @discardableResult
    func scrobbleStart(movie: RawJSON, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func scrobbleStart(episode: RawJSON, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
        return try scrobble("start",
                            movie: nil,
                            episode: episode,
                            progress: progress,
     ...
     */
    @discardableResult
    func scrobblePause(movie: RawJSON, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func scrobblePause(episode: RawJSON, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
        return try scrobble("pause",
                            movie: nil,
                            episode: episode,
                            progress: progress,
     ...
     */
    @discardableResult
    func scrobbleStop(movie: RawJSON, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
     ...
     */
    @discardableResult
    func scrobbleStop(episode: RawJSON, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
        return try scrobble("stop",
                            movie: nil,
                            episode: episode,
                            progress: progress,
    ...
    @discardableResult
    private func scrobble(_ scrobbleAction: String, movie: RawJSON?, episode: RawJSON?, progress: Float, appVersion: Float, appBuildDate: Date, completion: @escaping ObjectCompletionHandler<ScrobbleResult>) throws -> URLSessionDataTaskProtocol? {
        // JSON
        var json: RawJSON = [
            "progress": progress,
            "appVersion": appVersion,
