...
extension TraktManager {
    ...
    public struct CheckinResource {
         ...
         **Sharing**
         ...
         > note: If a checkin is already in progress, a  ``TraktManager/TraktError/conflict`` error will thrown. Use ``TraktManager/UsersResource/watching()`` to get the timestamp of when the check-in is completed.
