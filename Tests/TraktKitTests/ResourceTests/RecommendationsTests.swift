...
extension TraktTestSuite {
    ...
    struct RecommendationsTests {
        ...
        @Test func getMovieRecommendations() async throws {
            try await suite.mock(.GET, "https://api.trakt.tv/recommendations/movies", result: .success(jsonData(named: "test_get_movie_recommendations")))
        ...
        @Test func hideMovieRecommendation() async throws {
            try await suite.mock(.DELETE, "https://api.trakt.tv/recommendations/movies/922", result: .success(.init()))
        ...
        @Test func getShowRecommendations() async throws {
            try await suite.mock(.GET, "https://api.trakt.tv/recommendations/shows", result: .success(jsonData(named: "test_get_show_recommendations")))
        ...
        @Test func hideShowRecommendation() async throws {
            try await suite.mock(.DELETE, "https://api.trakt.tv/recommendations/shows/922", result: .success(.init()))
