...
final class ScrobbleTests: TraktTestCase {
    // MARK: - Start

    func test_start_watching_in_media_center() throws {
    ...
    func test_pause_watching_in_media_center() throws {
    ...
    func test_stop_watching_in_media_center() throws {
